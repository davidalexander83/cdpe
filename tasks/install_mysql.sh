...
MYSQL_ROOT_PASSWORD=$PT_password # SET THIS! Avoid quotes/apostrophes in the password, but do use lowercase + uppercase + numbers + special chars
...
sudo apt-get -y install mysql-server # Install MySQL quietly
